...
M-Trends 2026 is built on over 500,000 hours of frontline incident response — 83 campaigns across 73 countries. This is the fifth consecutive 2026 annual threat report in our ongoing series, following Unit 42, Cloudflare, CrowdStrike, and Picus. Mandiant brings something the others can't: the view from inside the compromised environment.
...
Five reports so far — and every one confirms the same conclusion. Voice over email. Recovery denial over encryption. AI-adaptive malware over static payloads. The organizations still defending against yesterday's threats are already compromised.
...
This is our fifth consecutive 2026 threat report deep dive — and the convergence keeps building. Unit 42 showed the speed. Cloudflare showed the infrastructure. CrowdStrike showed the scale. Picus showed the technique. Mandiant shows what the responders actually find when they arrive at the scene.

Five reports so far. One conclusion: voice over email, recovery denial over encryption, AI-adaptive malware over static payloads. The shift is permanent — and every new report confirms it.
