# FIR Risk Tuesday E61 - CLTC: The Roadmap to Community Cyber Defense

**Publish Date:** July 1, 2025
**Source:** [UC Berkeley CLTC — The Roadmap to Community Cyber Defense](https://cltc.berkeley.edu/publication/roadmap-to-community-cybersecurity/)
...
# FIR Risk E61 - Cybersecurity's Last Mile Problem

![FIR Risk E61 - CLTC Community Cyber Defense](images/E61-cltc-community-cyber-defense.png)
...
```
FIR Risk Tuesday E61 is out.

UC Berkeley CLTC — The Roadmap to Community Cyber Defense.
Cybersecurity's last mile problem:

→ Hospitals, schools, utilities, local governments — enterprise threats, minimal defenses
→ These aren't edge cases — they're the majority of U.S. organizations
→ Attackers target them because defenses are thin

Five building blocks for community cyber defense:
1. Trust-building
2. Service provision
3. Information sharing
4. Policy & governance
...
Enterprise security doesn't exist in isolation.

Full analysis: [link]

#CyberSecurity #CLTC #CommunityDefense #PublicSector #CISA
```
...
- Original published July 1, 2025
...
- Unique policy-focused edition — community defense rather than enterprise threat data
- Strong framing as "cybersecurity's last mile problem"
