# FIR Risk Tuesday — Best of E36

**Original Publish Date:** January 14, 2025
**Source:** [World Economic Forum — Global Cybersecurity Outlook 2025](https://www.weforum.org/publications/global-cybersecurity-outlook-2025/)
**Analysis:** FIR Risk Platform

---

# FIR Risk — Best of E36: 66% Say AI Will Reshape Cybersecurity. Only 37% Are Ready.

![FIR Risk Best of E36 - WEF Global Cybersecurity Outlook 2025](images/best-of-e36-wef-global-cybersecurity-outlook-2025.png)
...
The World Economic Forum's Global Cybersecurity Outlook 2025 reveals the gaps that will define this year:

66% of organizations believe AI will reshape cybersecurity within 12 months. Only 37% have security measures in place before deploying AI.

That 29-point gap is the story of 2025.

The full picture:
→ 60% say geopolitical tensions influence their cybersecurity strategy
→ 54% of large organizations rank supply chain as their #1 challenge
→ 42% experienced successful social engineering attacks in 2024
→ 35% of small organizations report insufficient cyber resilience (vs. 13% large)
→ 69% cite regulatory complexity as a major barrier
→ $12.5 billion in cybercrime costs exceeded in 2023
→ Skills gap widened another 8%

Eight converging risks: geopolitics, supply chain, RaaS industrialization, regulatory fragmentation, resilience gaps, workforce shortages, emerging tech, and rising economic impact.

These aren't isolated — they compound. Geopolitical tensions drive state attacks through supply chains against organizations with widening gaps, exploiting AI-powered vectors that defenders can't match due to skills shortages.

The threats aren't technical. They're organizational, strategic, and systemic.

Full analysis: [link]

Source: World Economic Forum — Global Cybersecurity Outlook 2025

#CyberSecurity #WEF #ThreatIntelligence #CISO #AI #SupplyChain #RiskManagement

---

## NOTES

- Single edition: E36 (January 14, 2025)
- WEF Global Cybersecurity Outlook is their flagship annual cybersecurity report
- Key SEO terms: "WEF cybersecurity outlook 2025", "global cybersecurity outlook", "World Economic Forum cybersecurity", "AI cybersecurity readiness"
- "66% Say AI Will Reshape Cybersecurity. Only 37% Are Ready." — the gap IS the headline
- 29-point gap between AI expectation and AI readiness is the unifying narrative
- Every stat connects to another Best of edition (supply chain→DBIR, SMB→DBIR/Forescout, geopolitics→CrowdStrike/CERT-EU, AI→multiple)
- 8 risk areas framework gives executives a complete taxonomy to reference
- 69% regulatory complexity finding is underreported — resource diversion from operations to compliance
- The "systemic" framing — SMB gaps creating supply chain risk creating enterprise risk — is the strategic insight
- MITRE ATT&CK less relevant for this edition — it's a strategic/organizational report, not a technical one
- Hero image: WEF branding / global risk visual
