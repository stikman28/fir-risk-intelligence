# FIR Risk Tuesday E59 - Cyentia Institute's 2025 Information Risk Insights Study

**Publish Date:** June 17, 2025
**Source:** [Cyentia Institute — IRIS 2025](https://cyentia.com/iris)
...
# FIR Risk E59 - 150,000 Incidents Prove Time Is the Variable That Matters

![FIR Risk E59 - IRIS 2025 Risk Insights](images/E59-iris-2025-risk-insights.png)
...
```
FIR Risk Tuesday E59 is out.

Cyentia Institute's IRIS 2025 — 150,000+ incidents over 15 years.
Time is the variable that matters most:

→ Sixfold increase in significant incidents over 15 years
→ Large firms ($100B+) are 620x more likely to be targeted
→ Median loss: $2.9M — tail risk: $32M
→ Financial losses up 15x absolute, 8x proportional to revenue
→ Professional services: 25x surge in median losses
→ Valid accounts still #1, but app exploits (38%) and misconfigs (30%) surging

Static risk models are increasingly misleading.

Full analysis: [link]

#CyberRisk #RiskManagement #CISO #Cyentia #IRIS2025 #ThreatIntelligence
```
...
- Source: Cyentia Institute — IRIS 2025 (150,000+ incidents, 2008–2024)
- Content pulled from LinkedIn newsletter via WebFetch for fir-risk-intelligence archive
- Original published June 17, 2025
...
- 620x enterprise targeting multiplier is the standout stat
- Strong risk quantification framing — good for board-level discussions
