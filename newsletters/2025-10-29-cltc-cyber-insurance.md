# FIR Risk Tuesday E72 - CLTC: Economics of Cyber Policies

**Publish Date:** October 29, 2025
**Source:** [Economics of Cyber Policies for Critical Care — CLTC White Paper](https://cltc.berkeley.edu/wp-content/uploads/2025/08/Economics_of_Cyber_Policies_for_Critical_Care.pdf)
...
# FIR Risk E72 - When Insurance Becomes a Security Tool

![FIR Risk E72 - CLTC Cyber Insurance Economics](images/E72-cltc-cyber-insurance.png)
...
```
FIR Risk Tuesday E72 is out.

UC Berkeley's CLTC studied cyber insurance economics in healthcare.
The findings apply to every sector.

The data:

→ 80% of orgs added security controls specifically to qualify for coverage
→ Smaller orgs pay ~$818/bed vs $369-645 for larger peers
→ Average healthcare breach: $9.77M — most caps are under $40M
→ Nation-state exclusions mean your policy may not cover the worst scenarios

Insurance isn't just a balance sheet tool anymore.
It's becoming the most effective security lever we have.

Full analysis: [link]

#CyberInsurance #CyberResilience #RiskManagement #CISO
```
...
- Source: CLTC White Paper — Economics of Cyber Policies for Critical Care (August 2025)
- Content pulled from LinkedIn newsletter via WebFetch for fir-risk-intelligence archive
- Original published October 29, 2025
- Reformatted to match 2026 newsletter template with INTEL callouts added
- Hero image downloaded from LinkedIn CDN
- Added editorial framing around "insurance as behavior lever" — strongest angle from the research
