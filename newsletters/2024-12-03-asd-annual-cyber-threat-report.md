# FIR Risk Tuesday — Best of E30

**Original Publish Date:** December 3, 2024
**Source:** [Australian Signals Directorate — Annual Cyber Threat Report 2023-24](https://www.cyber.gov.au/about-us/reports-and-statistics/annual-cyber-threat-report)
**Analysis:** FIR Risk Platform

---

# FIR Risk — Best of E30: A Five Eyes Intelligence Agency Shows Its Cards

![FIR Risk Best of E30 - ASD Annual Cyber Threat Report](images/best-of-e30-asd-annual-cyber-threat-report.png)
...
The Australian Signals Directorate just showed its cards.

ASD — Australia's equivalent of the NSA — published its Annual Cyber Threat Report. This isn't a vendor selling a product. It's a Five Eyes intelligence agency telling us what it sees.

The numbers:
→ 36,700+ hotline calls (up 12%)
→ 1,100+ incidents responded to
→ 82 million malicious domains blocked (up 21%)
→ 365 high-priority operational taskings (up 250%)
→ 1,372,400 indicators of compromise shared
→ 11% of incidents hit critical infrastructure

Nation-state assessment:
→ PRC using living-off-the-land for pre-positioning in critical infrastructure
→ Russia adapting techniques to exploit cloud platforms

Cybercrime costs by business size:
→ Small business: $49,600 (up 8%)
→ Medium business: $62,800 (down 35%)
→ Large business: $63,600 (down 11%)

The cost burden is shifting to the organizations least equipped to handle it.

When a Five Eyes agency increases high-priority operations by 250%, the underlying threat tempo has fundamentally shifted.

Full analysis: [link]

Source: Australian Signals Directorate — Annual Cyber Threat Report 2023-24

#CyberSecurity #ThreatIntelligence #CISO #CriticalInfrastructure #FiveEyes #NationState #ASD

---

## NOTES

- Single edition: E30 (December 3, 2024)
- ASD is Australia's signals intelligence agency — Five Eyes member alongside NSA, GCHQ, CSE, GCSB
- Key SEO terms: "ASD cyber threat report 2024", "Australian Signals Directorate", "Australia cybersecurity report", "Five Eyes cyber threat", "cybercrime costs Australia"
- "A Five Eyes Intelligence Agency Shows Its Cards" — positions this as authoritative government intelligence, not vendor marketing
- 250% high-priority taskings increase is the headline stat — signals step-change in threat tempo
- Cost-per-incident data by business size is unique to this report — enables board-level risk quantification
- PRC pre-positioning confirmed by intelligence agency — converges with CrowdStrike (150%), Mandiant (LOTL), Forescout (48% state-sponsored)
- Adds geographic diversity — first non-US/European perspective in the Best of collection
- Government intelligence perspective complements vendor reports (DBIR, M-Trends, CrowdStrike)
- 1.37M IOCs shared + 6,400 reports highlights the national intelligence sharing model
- Email compromise at 33% of top business crimes — connects to phishing/social engineering findings across all reports
- Hero image: ASD branding or Australian government cyber visual
