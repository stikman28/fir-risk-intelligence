# FIR Risk Tuesday E65 - CISO Priorities: 2025

**Publish Date:** July 29, 2025
**Source:** [Team8 — 2025 CISO Village Survey](https://team8.vc/rethink/ciso-survey-2025)
...
# FIR Risk E65 - 110 CISOs Told Us What Keeps Them Up at Night

![FIR Risk E65 - CISO Priorities 2025](images/E65-ciso-priorities-2025.png)
...
```
FIR Risk Tuesday E65 is out.

Team8's 2025 CISO Village Survey — 110 CISOs told us what keeps them up at night.

The priority stack:

→ #1 pain point: Securing AI Agents (39%)
→ 5 of the top 9 priorities are AI-related
→ 67% deploying agentic AI in 2025
→ Budgets tightening: 52% saw increases (down from 70%)
→ 60% prefer best-of-breed over platform consolidation
→ 77% expect AI to replace SOC tasks this year
→ 68% of breaches still caused by humans

The 2025 CISO agenda has been rewritten by AI.

Full analysis: [link]

#CISO #CyberSecurity #AI #AgenticAI #ShadowAI #Team8
```
...
- Original published July 29, 2025
- Reformatted to match 2026 newsletter template with INTEL callouts added
- Hero image downloaded from LinkedIn CDN
- AI agent security as #1 CISO pain point is the standout data point
- Budget tightening (52% vs 70%) signals procurement shift toward best-of-breed
