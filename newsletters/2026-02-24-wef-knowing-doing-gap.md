# FIR Risk Tuesday E80

**Publish Date:** February 24, 2026
**Source:** [World Economic Forum — Cybersecurity Stories](https://www.weforum.org/stories/categories/cybersecurity/) (February 2026)
**Analysis:** FIR Risk Platform

---

# FIR Risk E80 — From Knowing to Doing

![FIR Risk E80 - From Knowing to Doing](images/e80-wef-knowing-doing-gap.png)
...
Three reports. One week. Same message.

The World Economic Forum published three cybersecurity articles in February that tell the same story from different angles:

87% of leaders flag AI vulnerabilities as their fastest-growing cyber risk.

Fewer than 1% of organizations have fully operationalized responsible AI practices.

Adversaries are already collecting encrypted data today, expecting to decrypt it once quantum computing matures.

The common thread? The gap between knowing and doing.

Every organization surveyed understands the risk landscape. But understanding has not translated into the staffing, governance, and investment their security teams need to act.

The WEF data also reveals a disconnect at the top: CEOs rank cyber-enabled fraud as their greatest concern, while CISOs rank ransomware. That misalignment filters directly into budget decisions, headcount, and incident response planning.

Meanwhile, fewer than 1% have built AI governance into their operations. The WEF's playbook calls for named AI stewards, cross-functional councils, and phased oversight — not bureaucracy, but the foundation that lets innovation scale responsibly.

And on quantum security: the "harvest now, decrypt later" threat model means organizations with long-lived sensitive data may already be exposed. NIST finalized post-quantum cryptography standards in 2024. Most organizations haven't started planning.

Your cybersecurity, fraud, and risk teams understand these threats. What they need is authority, resources, and organizational commitment to close the gap.

The full analysis is in this week's FIR Risk Tuesday (E80): https://firrisk.ai/tuesday/e80-wef-knowing-doing-gap/

#CyberSecurity #RiskManagement #AIGovernance #QuantumSecurity #CISO #WEF #ThreatIntelligence #Leadership

---

## SOURCE DATA

**WEF Articles Referenced:**
1. [Cyber threats to watch in 2026, and other cybersecurity news](https://www.weforum.org/stories/2026/02/2026-cyberthreats-to-watch-and-other-cybersecurity-news/) — Feb 18, 2026
2. [The business advantage of strong AI governance](https://www.weforum.org/stories/2026/02/ai-governance-businesses-hold-them-back/) — Feb 20, 2026
3. [Why quantum security is a question leaders cannot ignore](https://www.weforum.org/stories/2026/02/quantum-security-question-leaders-cannot-ignore/) — Feb 20, 2026

**WEF Reports Referenced:**
- [Global Cybersecurity Outlook 2026](https://www.weforum.org/publications/global-cybersecurity-outlook-2026/) (PDF: [WEF_Global_Cybersecurity_Outlook_2026.pdf](https://reports.weforum.org/docs/WEF_Global_Cybersecurity_Outlook_2026.pdf))
- [Advancing Responsible AI Innovation: A Playbook](https://www.weforum.org/stories/2026/02/ai-governance-businesses-hold-them-back/)
- Global Risk Institute — Quantum Threat Timeline Report
- NIST Post-Quantum Cryptography Standards (2024)

**Other Sources:**
- US Federal Communications Commission — January 2026 ransomware guidance to telecoms
- UK AI Regulation Bill (reintroduced)
- EU AI Act
- EQTY Lab / NVIDIA — Verifiable Compute
- ProveAI — Training data lineage
