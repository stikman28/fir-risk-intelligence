# FIR Risk Tuesday E60 - Machine Identity Security: Cyber Debt
...
# FIR Risk E60 - The Identities You're Not Managing Are the Ones Getting Compromised

![FIR Risk E60 - Machine Identity Security](images/E60-machine-identity-security.png)
...
```
FIR Risk Tuesday E60 is out.

CyberArk's 2025 State of Machine Identity Security.
The identities you're not managing are the ones getting compromised:

→ 50% of orgs had machine identity security incidents last year
→ 79% expect up to 150% growth in machine identities this year
→ Only 23% prioritize machine identity security
→ 72% had certificate-related outages
→ Weekly outages jumped from 12% (2022) to 45% (2025)
→ 81% of CISOs say machine identity security is vital for AI

Machine identity is cyber debt.
And like all debt, it compounds.

Full analysis: [link]

#CyberSecurity #MachineIdentity #CyberArk #CISO #AI #Certificates
```
...
- Original published June 24, 2025
...
- 50% incident rate + 23% prioritization gap is the standout narrative
- Certificate outage trend (12% → 45% weekly) is strong visual data point
- Apple 47-day TLS lifespan adds urgency
