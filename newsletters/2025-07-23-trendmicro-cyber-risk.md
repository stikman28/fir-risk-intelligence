# FIR Risk Tuesday E64 - Cyber Risk Summary: Trend Micro

**Publish Date:** July 23, 2025
**Source:** [Trend Micro — 2025 Cyber Risk Report](https://www.trendmicro.com/vinfo/us/security/news/threat-landscape/trend-2025-cyber-risk-report)
...
# FIR Risk E64 - A Billion Accounts Without MFA

![FIR Risk E64 - Trend Micro Cyber Risk](images/E64-trendmicro-cyber-risk.png)
...
```
FIR Risk Tuesday E64 is out.

Trend Micro's 2025 Cyber Risk Report (Feb–Dec 2024 data).
The gap between knowing your risks and fixing them:

→ Cyber Risk Index: 38.4 average (medium risk)
→ 1 billion+ accounts lack MFA or password expiration
→ 57 million high-risk emails blocked (+27% YoY)
→ Mean time to patch: 41.3 days for large enterprises
→ All 10 riskiest CVEs of 2024 were patchable — yet unpatched
→ Active ransomware: LockBit, RansomHub, Black Basta

Cybersecurity isn't about stopping breaches.
It's about staying ahead.

Full analysis: [link]

#CyberSecurity #CyberRisk #TrendMicro #MFA #Ransomware #CISO
```
...
- Source: Trend Micro — 2025 Cyber Risk Report (Feb–Dec 2024 data, released March 2025)
- Content pulled from LinkedIn newsletter via WebFetch for fir-risk-intelligence archive
- Original published July 23, 2025
- Reformatted to match 2026 newsletter template with INTEL callouts added
- Hero image: LinkedIn CDN expired, needs manual save from article
- 1 billion accounts without MFA is the standout stat
- Patch time disparity (Europe 23.5d vs large orgs 41.3d) is strong executive talking point
