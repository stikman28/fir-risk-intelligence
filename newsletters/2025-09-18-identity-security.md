# FIR Risk Tuesday E70 - Identity Security 2025–2026
...
# FIR Risk E70 - Identity Is Your Security Nerve Center

![FIR Risk E70 - Identity Security 2025-2026](images/E70-identity-security.png)
...
```
FIR Risk Tuesday E70 is out.

SailPoint surveyed 375 IAM decision-makers.
The identity maturity gap is real — and widening.

The data:

→ 63% of enterprises are in the lowest two maturity horizons
→ Less than 40% govern AI agent identities
→ 4% of orgs actually regressed in 2025
→ 44% of advanced orgs still report poor identity data quality
→ Mature orgs see 2.8x cost savings and 10x+ ROI from IAM

Identity isn't an access gate anymore.
It's a security nerve center.

Full analysis: [link]

#IdentitySecurity #IAM #CISO #ZeroTrust #CyberSecurity
```
...
- Original published September 18, 2025
- Reformatted to match 2026 newsletter template with INTEL callouts added
- Hero image downloaded from LinkedIn CDN
- Strong data-driven piece — SailPoint survey provides quantitative benchmarks
