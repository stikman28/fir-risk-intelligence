# FIR Risk Tuesday E63 - State of Cybersecurity 2025

**Publish Date:** July 16, 2025
**Source:** [Accenture — State of Cybersecurity Resilience 2025](https://www.accenture.com/us-en/insights/security/state-cybersecurity)
...
# FIR Risk E63 - 90% of Organizations Can't Counter AI-Enabled Threats

![FIR Risk E63 - State of Cybersecurity 2025](images/E63-state-cybersecurity-2025.png)
...
```
FIR Risk Tuesday E63 is out.

Accenture's State of Cybersecurity Resilience 2025.
2,286 executives. 17 countries. The maturity gap is real:

→ 90% lack maturity to counter AI-enabled threats
→ Only 10% reach "Reinvention-Ready" status
→ 63% sit in the "Exposed Zone"
→ Cyberattacks surged 75% YoY (1,876 per org in Q3 2024)
→ 4.8 million unfilled cybersecurity positions globally
→ 88% struggle with Zero Trust implementation

The 10% who embedded security into AI transformation:
69% fewer advanced AI attacks. 1.6x higher ROI.

Full analysis: [link]

#CyberSecurity #AI #CISO #ZeroTrust #Accenture #CyberResilience
```
...
- Source: Accenture — State of Cybersecurity Resilience 2025 (2,286 execs, 17 countries, 24 industries)
- Content pulled from LinkedIn newsletter via WebFetch for fir-risk-intelligence archive
- Original published July 16, 2025
...
- 90% lacking AI threat maturity is the standout stat
- Reinvention-Ready vs Exposed Zone framing is strong executive narrative
