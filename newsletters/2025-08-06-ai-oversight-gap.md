# FIR Risk Tuesday E66 - The AI Oversight Gap
...
# FIR Risk E66 - Shadow AI Is Already Costing You $670,000

![FIR Risk E66 - The AI Oversight Gap](images/E66-ai-oversight-gap.png)
...
```
FIR Risk Tuesday E66 is out.

IBM's 2025 Cost of a Data Breach Report.
AI is on both sides of every breach now.

The numbers:

→ U.S. breach costs: $10.22M average (9% increase)
→ 1 in 6 breaches involve AI-powered attacks
→ Shadow AI adds $670,000 to breach costs
→ Security AI saves $1.9M and cuts 80 days from breach lifecycle
→ Healthcare: $7.42M per breach, 279 days to recover
→ Average breach lifecycle: 241 days

The oversight gap isn't whether you use AI.
It's whether you're governing it.

Full analysis: [link]

#CyberSecurity #AI #DataBreach #CISO #IBM #ShadowAI
```
...
- Original published August 6, 2025
- Reformatted to match 2026 newsletter template with INTEL callouts added
- Hero image downloaded from LinkedIn CDN
- Shadow AI $670K stat is the standout differentiator from other breach cost reporting
